...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \fbox{\includegraphics[width=\linewidth]{assets/paper_dummy_1.jpg}}
    % \caption{Caption a}
    \label{fig:a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \fbox{\includegraphics[width=\linewidth]{assets/paper_dummy_2.jpg}}
    % \caption{Caption b}
    \label{fig:b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \fbox{\includegraphics[width=\linewidth]{assets/paper_dummy_3.jpg}}
    % \caption{Caption c}
    \label{fig:c}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \fbox{\includegraphics[width=\linewidth]{assets/paper_dummy_4.jpg}}
    % \caption{Caption d}
    \label{fig:d}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \fbox{\includegraphics[width=\linewidth]{assets/paper_dummy_5.jpg}}
    % \caption{Caption e}
    \label{fig:e}
  \end{subfigure}
...
\todo[inline]{Skriv om sorte outlines}
\textbf{Outlines}\\
Vi har intentionelt designet alt det onde i spillet med sorte outlines. Dette er et stilistisk valg, som vi har truffet for at skabe en kontrast mellem det gode og det onde. Spilleren og båden har ikke nogen sort outline.

Vi kunne have opnået en lignende effekt ved at give det gode og det onde forskellige farvepaletter, men det ville formentlig kræve flere assets for at tydeliggøre effekten.

\todo[inline]{Skriv om spillets fortælling og et antropocentrisk perspektiv}

\subsection*{Spillets navn}
Spillet bærer navnet \textit{Project Plastic Waste}. Navnet er ikke blot beskrivende for spillets tema, men indeholder også en allitteration i de to P'er — \textit{Project} og \textit{Plastic} — hvilket gør navnet lettere at udtale og huske, da det falder naturligt i munden.
