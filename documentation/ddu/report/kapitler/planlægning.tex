...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{assets/todoeksempel.png}}
  \caption{Viser en to-do-note fra packagen \texttt{todonotes}. To-do-noten er en inline todo-note, da den ellers placeres i dokumentets margen, hvilket kan se mærkeligt ud, især når indholdet i todo-noten er tilpas stor.}\label{fig:todonote}
\end{figure}
